...
import cursojava.execao.ExecaoProcessaNota;
    ...
    public static void main(String[] args) {
        ...
        try {
            try{
                ...
                throw new ExecaoProcessaNota(e.getMessage());
            }
            ...
            JOptionPane.showMessageDialog(null, "erro ao imprimir notas "+saida.toString());
        }
        finally {
